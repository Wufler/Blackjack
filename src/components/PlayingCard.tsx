...
const getSuitIcon = (suit: string) => {
  switch (suit) {
    case "Spade":
      return <IconSpade className="text-gray-200 size-7" strokeWidth={3} />;
    case "Heart":
      return <IconHeart className="text-red-500 size-7" strokeWidth={3} />;
    case "Diamond":
      return <IconDiamonds className="text-red-500 size-7" strokeWidth={3} />;
    case "Club":
      return <IconClubs className="text-gray-200 size-7" strokeWidth={3} />;
    default:
      return null;
  }
};
