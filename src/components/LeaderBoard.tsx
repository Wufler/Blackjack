...
export default memo(function LeaderBoard({
  ...
  if (!dbConnected) {
    return (
      <div className="w-full rounded-lg bg-gray-800 p-4 shadow-lg md:w-80 md:self-stretch">
  ...
  return (
    <div className="w-full rounded-lg md:w-80 md:self-stretch md:bg-gray-800 md:p-4 md:shadow-lg">
                ...
                <div className="flex items-center gap-3 relative">
                  <div className="mr-16">
                    ...
                    <p className="text-sm opacity-75">
                      {formatDistanceToNowStrict(streak.createdAt, {
                        addSuffix: true,
                      })}
                    </p>
                  </div>
